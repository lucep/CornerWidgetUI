...
CornerWidgetUI._draw_ui = function (){
	...
	form_elem.innerHTML = CornerWidgetUI._ui_config["open_txt"][CornerWidgetUI._ui_config["default_lang"]] + "<input type='text' id='" + CornerWidgetUI.constants._uivar_leadnameID + "' placeholder ='Your Name' value='" + prev_name + "' /><input type='tel' id='" + CornerWidgetUI.constants._uivar_leadtelID +"'/><select id='" + CornerWidgetUI.constants._uivar_leadserviceID + "'>" + CornerWidgetUI._ui_config.menutree + "</select><div id='"+CornerWidgetUI.constants._uivar_botholder+"'><input type='text' id='" + CornerWidgetUI.constants._uivar_controlfield1 + "' placeholder='Your input' /><input type='text' id='" + CornerWidgetUI.constants._uivar_controlfield2 + "' placeholder='Your input' value='" + CornerWidgetUI.constants._formval_placeholder2 +"' /><button id='" + CornerWidgetUI.constants._uivar_kill + "'>Done</button></div><button id='" + CornerWidgetUI.constants._uivar_sendleadID  + "'>Call me!</button><span id='" + CornerWidgetUI.constants._uivar_formlabelID  + "' ><a href='https://www.lucep.com/?ref=" + (document.URL ? document.URL : window.location.href) + "&ac=" + CornerWidgetUI._ui_config.url + "&k=" + CornerWidgetUI._ui_config.kiosk_id + "&l=" + CornerWidgetUI._ui_config.default_lang +"' target='_blank' >Powered by Lucep</a></span>";
